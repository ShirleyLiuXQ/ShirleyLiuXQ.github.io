...
1. **X. Liu**, P. Cobo and R. Venkataramanan (2024) Many-user multiple access with random user activity ([poster](ESIT_GMAC_poster_final.pdf) at [IEEE European School of Information Theory 2023 (ESIT)](https://www.bristol.ac.uk/maths/events/2023/esit-2023.html)), in review, submitted version available on request.
...
2. **X. Liu**, K. Hsieh and R. Venkataramanan (2024) Coded many-user multiple access via Approximate Messsage Passing, in review, submitted version available on request.
...
3. G. Arpino, **X. Liu** and R. Venkataramanan (2024) Changepoints detection in high-dimensional linear regression, in review, submitted version available on request.
