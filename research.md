...
## Get in touch:
I've come to realise that clear thinking and clear presentation reinforce each other, so I spend a lot of time structuring and crafting my papers and talks. Most papers below are accompanied with **talk slides**, which give a more visual and high-level explanation of the same technical ideas. If you have any feedback, or if anything is unclear, I’d love to hear from you. I’m always happy to discuss or explain further, and questions often help me see where clarity could be improved. :)

## Selected preprints & publications:

1. A. Buna, **S.X. Liu**, P. Rebeschini, "[Minimax Optimal Early-Stopped Gradient Descent for Gaussian Mixture Classification](https://arxiv.org/abs/2608.06250)", accepted to *Proceedings of the 40th Annual Conference on Neural Information Processing Systems*, 2026. ([talk](talk_on_early_stopped_GD(10mins).pdf))
2. **X. Liu**, D. Baudry, J. Zimmert, P. Rebeschini, A. Akhavan, "[Non-stationary Bandit Convex Optimization: A Comprehensive Study](https://arxiv.org/abs/2506.02980)", *Proceedings of the 39th Annual Conference on Neural Information Processing Systems*, 38, pp.65559-65599, 2025. ([talk](CDT_bandits_talk(20mins).pdf), [poster](neurips_poster_bandits.pdf))
